...
const ProductList = () => {
  ...
  return (
    <div className="flex max-w-7xl mx-auto bg-white min-h-screen" ref={topRef}>
      ...
      <div className={`fixed top-105px] bottom-[105px] right-0 w-64 bg-white border-l border-gray-200 overflow-y-auto z-40 transition-transform transform md:translate-x-0 ${sidebarVisible ? "translate-x-0" : "translate-x-full"} md:block hidden`}>
