      ...
      {cambiosEstado.length > 0 && (
        <div className="fixed inset-0 z-[9999] flex items-center justify-center bg-black/40 px-4">
          <div className="w-full max-w-md rounded-lg bg-white p-5 shadow-xl">
            <h3 className="text-lg font-semibold text-gray-800 mb-2">Actualización de pedido</h3>
            <p className="text-sm text-gray-700 mb-1">
              Pedido <strong>#{cambiosEstado[0].numero}</strong>
            </p>
            <p className="text-sm text-gray-700 mb-4">
              Su estado cambió a:{" "}
              <strong className="capitalize">{cambiosEstado[0].estado}</strong>
            </p>
            <div className="flex items-center justify-end gap-2">
              <button
                onClick={() => setCambiosEstado((prev) => prev.slice(1))}
              ...
              <button
                onClick={() => {
                  const id = cambiosEstado[0].id;
                  setCambiosEstado((prev) => prev.slice(1));
